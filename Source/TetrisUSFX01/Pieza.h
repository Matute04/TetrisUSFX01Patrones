...
UCLASS()
class TETRISUSFX01_API APieza : public AActor, public IPiezaInterfaz
{
	GENERATED_BODY()
...
public:
	void SpawnBlocks();
	void setColors(int _colors) { Color = _colors; }
	int getColors() { return Color; }
	void setRotacionY(float _RotacionY) { RotacionY = _RotacionY; }
	float getRotacionY() { return RotacionY; }
	void setRotacionZ(float _RotacionZ) { RotacionZ = _RotacionZ; }
	float getRotacionZ() { return RotacionZ; }
};
