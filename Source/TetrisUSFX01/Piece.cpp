...
APiece::APiece()
{
    ...
    struct FConstructorStatics  
    {
        ...
        FConstructorStatics()                                                   // "F" indica que es una estructura de datos de la biblioteca básica de Unreal Engine.
            ...
            , Color_9(TEXT("Material'/Game/StarterContent/Materials/M_CobbleStone_Rough.M_CobbleStone_Rough'"))
...
void APiece::SpawnBlocks()
{
    ...
    Index = FMath::RandRange(0, Shapes.size() - 1);               // Generar un número aleatorio entre 0 y el tamaño de la lista de piezas
