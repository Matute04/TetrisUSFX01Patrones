...
#include "NivelBasico.h"
#include "Block.h"
#include "Components/SceneComponent.h"
#include <vector>

// Sets default values
ANivelBasico::ANivelBasico()
{
...
void ANivelBasico::CrearNivel()
{
    ...
    for (auto&& YZ : YZs)
    {
        ...
        B->BlockMesh->SetMaterial(1, Colors[4]);
        Blocks.Add(B);
...
void ANivelBasico::MostrarInformacion()
{
    GEngine->AddOnScreenDebugMessage(-1, 10, FColor::Black, TEXT("Nivel Basico, Obstaculo Linea"));
}

// Called when the game starts or when spawned
void ANivelBasico::BeginPlay()
{
    Super::BeginPlay();
    CrearNivel();
    MostrarInformacion();
...
// Called every frame
void ANivelBasico::Tick(float DeltaTime)
{
